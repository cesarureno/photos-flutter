...
import 'package:photos/models/PhotoModel.dart';
import 'package:photos/services/PhotosServices.dart';
...
class PhotoProvider extends ChangeNotifier {
  ...
  Future<void> callPhotoApi() async {
    await PhotosServices().getPhotos(_page, 'nature').then((response) {
      _page = _page + 1;
